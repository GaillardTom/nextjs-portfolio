...
# My Experience at DCM4

<img src="/images/dcm4.jpg" alt="DCM4"/>


## Introduction

The British Army hosted a Red vs Blue cyber competition called Defence Cyber Marvel 4 (DCM4), which is one of the [biggest cyber competition in western europe for NATO](https://www.army.mod.uk/news/global-cyber-competition-secures-and-strengthens-key-relationships/).
...
> Notes: 
    This blog is from my own perspective and I will not disclose any sensitive information.
        It is only about what I, personally, accomplished during the competition.
## Range Diagram
...
<img src="/images/CSMailPersistence.png" alt="CS Beacons"/>
#### Day 2:
...
<img src="/images/InitialEntryMail.png" alt="CS Beacons"/>
#### Day 4 & 5:
Unfortunately, I was not able to participate in the last 2 days of the competition.
From what I heard, they wreaked havoc on the blue teams, but they were able to counter us after a bit of time.
...
out the attacks. I had a ton of fun and learned a lot during dcm4, I am looking forward to the next edition and hope to be able to participate again.<br/> Sending love from Canada🍁! 
<br/>
