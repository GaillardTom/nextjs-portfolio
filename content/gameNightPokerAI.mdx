...
I was a developer for this challenge, working with a team. I had lots of fun and learned a lot about AI and poker in general.
...
We used a Decision Tree (DT2) model to predict the best hand and a Random Forest model to predict the highest hand possible on the table.
...
While that was cooking, we also created a bunch of different model being more passive, more aggressive, and so on. We then ran the test again to see which one was the best. We found out that the original version was the best and we decided to stick with it.
## Results
