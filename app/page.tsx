        ...
        <div className="work flex flex-col mt-10"> 
          ...
          <div className="card w-full p-2 flex flex-col relative hover:scale-110 transition ease-linear duration-300" style={{ maxWidth: "200rem", minHeight:"250px", }}>
            ...
            <div className="card-body flex-grow">
              ...
              <p className="card-text indent-4"> Cyber and numeric operator for the 35 signal unit.<br/>
          ...
          <div className="card w-full p-2 flex flex-col relative hover:scale-110 transition ease-linear duration-300" style={{ maxWidth: "200rem", minHeight:"250px", }}>
            ...
            <div className="card-body flex-grow">
              ...
              <p className="card-text indent-4">On site support technicians for health workers at the CHUS de l'Estrie working on different sites, from hardware to application problems, and updated some of their powershell scripts.</p>
            </div>
          </div>
        </div>
