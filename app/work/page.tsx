...
export default function Page() {
  ...
  const projects = [
    ...
    { title: 'Orientation Site', description: 'Webapp to get the educational requirements based on a given job, using data from the O*NET database',
     ...
     {title: 'My Portfolio', description: 'This website! Made with Next.js, TailwindCSS, and deployed on Vercel', link:'https://nextjs-portfolio-chi-ruby.vercel.app/', image: '/portfolio.jpg', source: 'https://github.com/GaillardTom/nextjs-portfolio'},
