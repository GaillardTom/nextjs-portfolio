...
export function Tags({tagsDict, redirect, selectedTag}) {
  return (
    <div className="collapse group md:visible lg:visible flex-wrap grid grid-cols-2 gap-2 fixed lg:left-44 md:top-16 right-5 lg:right-auto w-32 lg:w-auto lg:top-auto border-b-2 border-gray-500 md:right-20">
        ...
        <div className='invisible md:visible lg:visible  border-b-2 border-gray-500 mb-4 -ml-[6%]'></div>
